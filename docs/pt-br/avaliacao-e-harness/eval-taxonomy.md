...
- `https://arxiv.org/html/2604.01527v1` — defende exec-based (fail-to-pass tests) e mostra impacto do harness/tooling.
- `https://www.swebench.com/` — benchmark repo-level amplamente usado; útil para comparar agentes.
